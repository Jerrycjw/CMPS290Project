...
groud_truth_path = '/Users/Jerry/Documents/CMPS290H/Project/data/temp/ground_truth.pkl'
try:
    with open(groud_truth_path, 'rb') as f:
        DDL.update_gt(cPickle.load(f))
except:
    ...
    with open(groud_truth_path, 'w+') as f:
        cPickle.dump(DDL.get_ground_truth(), f)
...
DDL.learn_weights(sample=False, n_iter=500, alpha=0.5, mu=mu_seq,bias=True, verbose=True, log=True)
